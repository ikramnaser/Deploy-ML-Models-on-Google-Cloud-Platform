...
def main():
    # Load the dataset
    data = pd.read_csv("C:/Users/ikry/Downloads/heart.csv")
    # Prepare data
...
def prepare_data(data):
    ...
    X = data[data.columns.difference(['output'])]
    y = data['output']
...
def create_data_preprocessor():
    ...
    numerical_columns = ['age', 'cp', 'trtbps', 'chol', 'thalachh', 'oldpeak', 'slp', 'caa', 'thall', ]
    categorical_columns = ['sex', 'fbs', 'restecg', 'exng']
